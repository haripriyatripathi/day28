...
import { Sparkles, ArrowRight, Shield, Heart, Award, Stethoscope } from 'lucide-react';
...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      {/* Soft floating shapes - Rose themed */}
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-primary/8 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-secondary/8 rounded-full blur-3xl animate-float-delayed" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Headline with Rose Pink accent */}
          <motion.h1
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <br />
            <span className="gradient-text-rose">Emotional Wellness.</span>
            <br />
            <span className="gradient-text-secondary">Trusted Care.</span>
          </motion.h1>
